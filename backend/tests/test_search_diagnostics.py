...
def test_search_tool_invalid_key(monkeypatch):
    class _Settings:
...
def test_search_tool_network_error(monkeypatch):
    class _Settings:
...
def test_search_tool_rate_limited(monkeypatch):
    class _Settings:
        search_provider = "tavily"
...
def test_search_tool_tavily_provider_deduplicates_and_scores(monkeypatch):
    class _Settings:
        search_provider = "tavily"
        tavily_api_key = "tavily-key"
        serpapi_api_key = None
